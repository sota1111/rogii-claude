...
# --- Constrained + stochastic (Gumbel) DTW alignment candidate (SOT-2444) ---
# The block between the DTW_SHARED_CODE markers is copied verbatim from
# src/dtw_align.py so the two entry points stay byte-identical (tests/test_dtw_align.py).
